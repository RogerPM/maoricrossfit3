...
class DetailClassesControllerTest < ActionController::TestCase
  ...
  test "should create detail_class" do
    assert_difference('DetailClass.count') do
      post :create, detail_class: { client_id: @detail_class.client_id, comment: @detail_class.comment, state: @detail_class.state, subscription_id: @detail_class.subscription_id }
    end
  ...
  test "should update detail_class" do
    patch :update, id: @detail_class, detail_class: { client_id: @detail_class.client_id, comment: @detail_class.comment, state: @detail_class.state, subscription_id: @detail_class.subscription_id }
    assert_redirected_to detail_class_path(assigns(:detail_class))
  end
