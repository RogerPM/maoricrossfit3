...
class ChecksControllerTest < ActionController::TestCase
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post :create, check: { bank: @check.bank, num: @check.num, owner: @check.owner, sale_id: @check.sale_id, value: @check.value }
    end
  ...
  test "should update check" do
    patch :update, id: @check, check: { bank: @check.bank, num: @check.num, owner: @check.owner, sale_id: @check.sale_id, value: @check.value }
    assert_redirected_to check_path(assigns(:check))
  end
